/*!
 * Author: Enrico Murru
 * Description: Module have been edited because the $.widget was not loaded.
 * 
 * BlockRain.js 0.2.0
 ...
 */
 // jQuery Widget
define("blockrain",["jquery", "jquery-ui"],
    function($){
  "use strict";
    ...
    _SetupBoard: function() {
      ...
      this._board = {
        ...
        nextShape: function(_set_next_only) {
          ...
          game.options.onNext && game.options.onNext.call(game.element, this.next);
